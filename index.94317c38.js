...
})({"k74Sb":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "16e48da494317c38";
"use strict";
...
},{}],"lLZ30":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _auto = require("chart.js/auto");
var _autoDefault = parcelHelpers.interopDefault(_auto);
(0, _autoDefault.default).defaults.color = "#AAAAAA";
(0, _autoDefault.default).defaults.borderColor = "#555555";
(async function() {
    const best_data = [
        {
            "location": "\u751F\u7269\u4E2D\u5FC3",
            "upload": 74.2323980264472,
            "download": 73.0620130926339
        },
        {
            "location": "\u91D1\u5DE5\u4E2D\u5FC3",
            "upload": 65.3316601912738,
            "download": 72.6595024914991
        },
        {
            "location": "\u56FE\u4E66\u9986\u4E09\u697C",
            "upload": 58.3026373127944,
            "download": 48.7272244387458
        },
        {
            "location": "\u56FE\u4E66\u9986\u4E00\u697C",
            "upload": 55.541803972588,
            "download": 27.5261617231185
        },
        {
            "location": "\u897F\u6559\u4E00\u697C",
            "upload": 52.4534685449204,
            "download": 48.5537872206187
        },
        {
            "location": "\u4E1C\u6559\u4E8C\u697C",
            "upload": 52.2565537857628,
            "download": 47.3319436531563
        },
        {
            "location": "\u56FE\u4E66\u9986\u519C\u533B\u5206\u9986",
            "upload": 50.4586817086757,
            "download": 50.4704796783427
        },
        {
            "location": "\u52A8\u7269\u79D1\u5B66\u5B66\u9662",
            "upload": 50.4050448545822,
            "download": 44.2693076377552
        },
        {
            "location": "\u5927\u98DF\u5802\u4E00\u697C",
            "upload": 50.3568195993581,
            "download": 50.4679463565883
        },
        {
            "location": "\u519C\u5B66\u9662",
            "upload": 50.3040055385896,
            "download": 50.2273329357416
        }
    ];
    const worst_data = [
        {
            "location": "\u4E1C\u6559\u4E8C\u697C",
            "upload": 1.14991686345741,
            "download": 8.26835529278388
        },
        {
            "location": "\u5927\u98DF\u5802\u4E00\u697C",
            "upload": 1.32296364588879,
            "download": 3.41888625253211
        },
        {
            "location": "\u5F00\u7269\u82D1",
            "upload": 2.04439901379732,
            "download": 12.5265111258519
        },
        {
            "location": "\u7D2B\u91D1\u6E2F\u673A\u623F",
            "upload": 2.55603277990018,
            "download": 2.79830999601791
        },
        {
            "location": "\u6C14\u819C\u9986",
            "upload": 4.16028357361946,
            "download": 14.2845620745311
        },
        {
            "location": "\u9075\u4E49\u8DEF-\u519C\u5B66\u9662",
            "upload": 4.25428186803105,
            "download": 9.14125434620834
        },
        {
            "location": "\u827A\u535A\u9986",
            "upload": 4.56814422894782,
            "download": 36.8081415585423
        },
        {
            "location": "\u751F\u547D\u79D1\u5B66\u5B66\u9662",
            "upload": 4.61810090524129,
            "download": 43.6970586465353
        },
        {
            "location": "\u6587\u5316\u827A\u672F\u4E2D\u5FC3",
            "upload": 4.92571813319225,
            "download": 41.1525096937378
        },
        {
            "location": "\u4E3B\u56FE\u4E00\u5C42",
            "upload": 5.0594550541814,
            "download": 10.7567472285706
        }
    ];
    new (0, _autoDefault.default)(document.getElementById("best_canvas"), {
        type: "bar",
        data: {
            labels: best_data.map((row)=>row.location),
            datasets: [
                {
                    label: "\u4E0A\u4F20",
                    data: best_data.map((row)=>row.upload)
                },
                {
                    label: "\u4E0B\u8F7D",
                    data: best_data.map((row)=>row.download)
                }
            ]
        }
    });
    new (0, _autoDefault.default)(document.getElementById("worst_canvas"), {
        type: "bar",
        data: {
            labels: worst_data.map((row)=>row.location),
            datasets: [
                {
                    label: "\u4E0A\u4F20",
                    data: worst_data.map((row)=>row.upload)
                },
                {
                    label: "\u4E0B\u8F7D",
                    data: worst_data.map((row)=>row.download)
                }
            ]
        }
    });
    new (0, _autoDefault.default)(document.getElementById("good_perc_canvas"), {
        type: "doughnut",
        data: {
            labels: [
                "\u4F18\u79C0",
...
},{}]},["k74Sb","lLZ30"], "lLZ30", "parcelRequiref35e")

//# sourceMappingURL=index.94317c38.js.map
